...
languages = {
    "🇺🇸 English": {
        ...
        "min_break": "Min. total days per block",
        ...
        "holidays_consume": "Holidays use up your balance days?",
        "h_holidays_consume": "If checked, holidays occurring during your vacation will count towards your used balance days.",
        ...
        "h_vac_days": "Total number of balance days you have available.",
        ...
        "h_pto_min_max": "Limits on the balance days used per block.",
        ...
        "h_min_gap": "Minimum number of days between two vacation blocks to ensure they are well distributed throughout the year.",
        ...
        "h_must_start_on": "Force vacation blocks to start exactly on these dates (e.g., for booked flights). The number of dates cannot exceed the 'Max Vacation Periods'.",

        "must_end_on": "Fixed End Dates",
        "h_must_end_on": "Force vacation blocks to end exactly on these dates. The number of dates cannot exceed the 'Max Vacation Periods'.",

        "section_months": "Months",
        "required_months": "Full vacations in:",
        "h_required_months": "The vacation block must start and end entirely within the selected months.",
