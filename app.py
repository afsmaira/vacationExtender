...
languages = {
    "🇺🇸 English": {
        ...
        "caption": "Legend:<br>PTO = Vacation days used<br>TOTAL = Total days off (including holidays and weekends)",
    ...
    "🇧🇷 Português": {
        ...
        "caption": "Legenda:<br>PTO = Dias de férias usados<br>TOTAL = Dias totais de descanso (incluindo feriados e fins de semana)",
